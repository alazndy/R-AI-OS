...
fn add(rule: &str, path: Option<PathBuf>, json: bool) {
    use raios_runtime::instinct::{append_to_memory_md, InstinctEngine};
...
fn list(path: Option<PathBuf>, json: bool) {
    use raios_runtime::instinct::{load_project_rules, InstinctEngine};
...
fn suggest(project: Option<String>, dev_ops: &Path, _json: bool) {
    use raios_runtime::health::check_project;
    use raios_runtime::instinct::{append_to_memory_md, suggest_from_health, InstinctEngine};
