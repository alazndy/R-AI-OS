...
pub struct ClientHandle {
    ...
    pub graph_store: Arc<crate::task_graph::GraphStore>,
    pub swarm_store: Arc<crate::swarm::store::SwarmStore>,
    pub evolution_store: Arc<crate::evolution::CandidateStore>,
    pub umai: crate::security::Umai,
}

pub async fn handle_client_connection(h: ClientHandle) {
    // Unpack into the same local names the original spawn block used —
    // this keeps the diff minimal and avoids mass-rename churn.
