...
<!-- Updated: 2026-08-17T22:17:00.061Z -->
...
```
tools/raios-tray/raios-tray.py                +valid_notification_client_id  +fallback_notification_client_id  +notification_client_id  +_check_important_notifications
```
...
```
pub async fn start_health_worker(state: Arc<RwLock<DaemonState>>, tx: broadcast::Sender<String>, interval: Duration,)  :78-183
```
