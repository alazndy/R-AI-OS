...
<!-- Updated: 2026-07-15T12:27:29.967Z -->
...
pub fn record_approval_decision(store: &CandidateStore, tool_name: &str, project: &str, approved: bool, threshold: usize,) → bool
...
pub fn create_task_graph_node_workflow(conn: &Connection, graph_id: &str, node_id: &str, description: &str, shell_cmd: &str, agent_name: &str, ready: bool,) → Result<raios_core::control_...
pub fn insert_verify_gate_node(conn: &Connection, graph_id: &str, node_id: &str, description: &str, shell_cmd: &str, agent_name: &str, ready: bool,) → Result<raios_core::control_...
pub fn create_task_graph_edges(conn: &Connection, graph_id: &str, node_task_ids: &std::collections::HashMap<String, String>, nodes: &[raios_core::task_graph::NodeSpec],) → Result<()>
...
impl PolicyConfig
  ...
  pub fn validate_tool_call_with_hook(&self, tool_name: &str, payload: Option<super::hooks::HookPayload>,) → Result<()>
