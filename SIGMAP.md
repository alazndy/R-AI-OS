...
<!-- Updated: 2026-08-07T13:47:21.890Z -->
...
```
pub struct AgentProcess  :42-48
pub struct ExecutionProxy  :51-54
impl ExecutionProxy  :56-263
  pub fn new(state: Arc<RwLock<DaemonState>>) → Self  :57-57
  pub fn with_event_tx(mut self, tx: tokio::sync::broadcast::Sender<String>) → Self  :64-64
  pub async fn spawn_agent(&self, agent_name: &str, project_path: &str, timeout_secs: u64,) → Result<String>  :81-86
  pub async fn spawn_via_tmux(&self, id: Uuid, program: &str, args: &[String], cwd: &str, timeout_secs: u64,) → Result<()>  :170-177
```

### crates/raios-runtime/src/daemon_client.rs
```
pub fn steer_agent_via_http(agent_id: &str, message: &str, sender: &str) → Result<()>  :24-26
pub fn steer_agent_at(base_url: &str, agent_id: &str, message: &str, sender: &str) → Result<()>  :33-59
```
...
pub fn load  :79-79
pub fn load_from  :84-84
pub fn save  :157-157
pub fn is_indexed  :162-162
pub fn upsert_file  :167-172
pub fn default_db_path  :9-14
```
