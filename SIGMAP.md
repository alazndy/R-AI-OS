...
<!-- Updated: 2026-08-10T22:27:38.231Z -->
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-core/src/safe_io.rs
```
pub fn safe_write  :11-61
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/compressor/diff.rs
```
pub fn distil(diff: &str) → String  :14-95
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/compressor/metrics.rs
```
pub fn estimate_tokens(text: &str) → usize  :4-6
pub fn savings_pct(original: &str, compressed: &str) → f64  :9-16
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/compressor/mod.rs
```
pub fn apply(tool: &str, response: &mut Value)  :31-50
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/constitution.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/control_plane/service.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/cortex/chunker.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/cortex/store.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/cortex.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/git.rs
```
pub async fn start_git_worker(state: Arc<RwLock<DaemonState>>, tx: broadcast::Sender<String>, interval: Duration,)  :8-121
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/handlers.rs
```
pub struct ClientHandle  :71-87
pub async fn handle_client_connection(h: ClientHandle)  :105-220
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/health.rs
```
pub async fn start_health_worker(state: Arc<RwLock<DaemonState>>, tx: broadcast::Sender<String>, interval: Duration,)  :37-130
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/lifecycle.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/proxy.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/scheduler.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/sentinel.rs
```
pub async fn start_sentinel_worker(state: Arc<RwLock<DaemonState>>, tx: broadcast::Sender<String>, interval: Duration,)  :11-104
```

### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/server.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/state.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/daemon/validation.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/discovery.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/factory.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/filebrowser/agents.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/filebrowser/files.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/filebrowser/git.rs
```
...
### .claude/worktrees/bootstrap-safety-plan/crates/raios-runtime/src/filebrowser/mod.rs
```
