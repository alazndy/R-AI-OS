...
<!-- Updated: 2026-06-25T15:15:39.952Z -->
...
.github/copilot-instructions.md:27  # TODO: implement later`. Always full, compilable context.
.github/copilot-instructions.md:28  # TODO: s
.github/copilot-instructions.md:29  # TODO: implement later`. Always full, compilable context.
.github/copilot-instructions.md:30  # TODO: s
.github/copilot-instructions.md:31  # TODO: implement later`. Always full, compilable context.
.github/copilot-instructions.md:32  # TODO: s
.github/copilot-instructions.md:33  # TODO: implement later`. Always full, compilable context.
.github/copilot-instructions.md:34  # TODO: s
.github/copilot-instructions.md:35  # TODO: implement later`. Always full, compilable context.
.github/copilot-instructions.md:36  # TODO: s
.github/copilot-instructions.md:37  # TODO: implement later`. Always full, compilable context.
```

## changes (last 10 commits — 2 hours ago)
```
vscode-extension/src/ipc/DaemonClient.ts      ~DaemonClient
vscode-extension/src/ipc/TokenBridge.ts       ~TokenBridge
.github/copilot-instructions.md               +Agent  +TrayState  +FetchWorker  +run
vscode-extension/src/utils/raiosBinary.ts     +raiosConfigDir  +tokenFilePath  ~tokenFilePath  ~resolveAiosdBinary
```
...
h2 deps
h2 todos
h2 changes (last 10 commits — 81 minutes ago)
h2 .github
h3 .github/copilot-instructions.md
h2 src
h3 src/security/auth.rs
h3 src/security/egress.rs
h3 src/security/license.rs
h3 src/security/mod.rs
h3 src/security/patterns.rs
h3 src/security/policy.rs
h3 src/security/quarantine.rs
h3 src/security/rate_limiter.rs
h3 src/security/sandbox.rs
h3 src/security/scanner.rs
h3 src/security/secret_lease.rs
h3 src/security/tool_pin.rs
h3 src/ui/health.rs
h3 src/ui/panels/policies.rs
h3 src/swarm/mod.rs
h3 src/task_graph.rs
```
