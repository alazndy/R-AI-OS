...
<!-- Updated: 2026-07-08T00:09:30.354Z -->
...
```
.github/copilot-instructions.md               +Agent  +TrayState  +PathInput  +SettingsDialog
```
...
h2 crates
h3 crates/raios-core/src/db/wf_file_change.rs
h3 crates/raios-core/src/db/wf_task_graph.rs
