...
## Current Focus
- Security kernel + UMAI complete. Project in hardening/expansion mode.
- Next candidates: VS Code extension package bump, cortex RAM kullanımı araştırması (5.8GB peak), tray macOS/Windows validasyonu.
